CREATE PROCEDURE [dbo].[uspGET_ServiceSampleAnalysisData_12MonthRolling]
	@RunDate DATE
AS
	...
	*/
	...
	/* RETURN JLR SERVICE RETENTION BY MARKET / MIS */
		...
		UPDATE R
			SET 
				...
				, [00-15MIS %] = CAST(CAST(ROUND((CAST(SR.[00-15MIS] AS DECIMAL(15, 2)) / CAST(SR.NumberOfSales AS DECIMAL(15, 2))) * 100, 0) AS INT) AS VARCHAR(5)) + '%'
				, [16-30MIS %] = CAST(CAST(ROUND((CAST(SR.[16-30MIS] AS DECIMAL(15, 2)) / CAST(SR.NumberOfSales AS DECIMAL(15, 2))) * 100, 0) AS INT) AS VARCHAR(5)) + '%'
				, [31-45MIS %] = CAST(CAST(ROUND((CAST(SR.[31-45MIS] AS DECIMAL(15, 2)) / CAST(SR.NumberOfSales AS DECIMAL(15, 2))) * 100, 0) AS INT) AS VARCHAR(5)) + '%'
				, [46-60MIS %] = CAST(CAST(ROUND((CAST(SR.[46-60MIS] AS DECIMAL(15, 2)) / CAST(SR.NumberOfSales AS DECIMAL(15, 2))) * 100, 0) AS INT) AS VARCHAR(5)) + '%'
		FROM #ServiceRetention SR
		INNER JOIN #JLRMISReport R ON SR.Manufacturer = R.Manufacturer
									AND SR.Market = R.Market
									AND SR.YearOfSales = R.YearOfSales		
		WHERE SR.Market IN ('Brazil', 'China', 'France', 'Germany', 'Japan', 'Netherlands', 'Portugal', 'Russian Federation', 'Spain', 'Switzerland', 'UK')
		...
		UPDATE R
			SET 
				...
				, [00-15MIS %II] = CAST(CAST(ROUND((CAST(SR.[00-15MIS] AS DECIMAL(15, 2)) / CAST(SR.NumberOfSales AS DECIMAL(15, 2))) * 100, 0) AS INT) AS VARCHAR(5)) + '%'
				, [16-30MIS %II] = CAST(CAST(ROUND((CAST(SR.[16-30MIS] AS DECIMAL(15, 2)) / CAST(SR.NumberOfSales AS DECIMAL(15, 2))) * 100, 0) AS INT) AS VARCHAR(5)) + '%'
				, [31-45MIS %II] = CAST(CAST(ROUND((CAST(SR.[31-45MIS] AS DECIMAL(15, 2)) / CAST(SR.NumberOfSales AS DECIMAL(15, 2))) * 100, 0) AS INT) AS VARCHAR(5)) + '%'
				, [46-60MIS %II] = CAST(CAST(ROUND((CAST(SR.[46-60MIS] AS DECIMAL(15, 2)) / CAST(SR.NumberOfSales AS DECIMAL(15, 2))) * 100, 0) AS INT) AS VARCHAR(5)) + '%'
		FROM #ServiceRetention SR
	...
	/* RETURN JLR SERVICE RETENTION 2 + SERVICE EVENTS WITHIN 36 MIS */
		...
		UPDATE R
			...
			, [+2Events36MIS %] = CAST(CAST(ROUND((CAST(SR.[+2EVENTS36MIS] AS DECIMAL(15, 2)) / CAST(SR.NumberOfSales AS DECIMAL(15, 2))) * 100, 0) AS INT) AS VARCHAR(5)) + '%'
			, [+2Events37-72MIS] = SR.[+2Events37-72MIS]
			, [+2Events37-72MIS %] = CAST(CAST(ROUND((CAST(SR.[+2EVENTS37-72MIS] AS DECIMAL(15, 2)) / CAST(SR.NumberOfSales AS DECIMAL(15, 2))) * 100, 0) AS INT) AS VARCHAR(5)) + '%'
		FROM #ServiceRetention sr
		...
		UPDATE R
			...
			, [+2Events36MIS %II] = CAST(CAST(ROUND((CAST(SR.[+2EVENTS36MIS] AS DECIMAL(15, 2)) / CAST(SR.NumberOfSales AS DECIMAL(15, 2))) * 100, 0) AS INT) AS VARCHAR(5)) + '%'
			, [+2Events37-72MISII] = SR.[+2Events37-72MIS]
			, [+2Events37-72MIS %II] = CAST(CAST(ROUND((CAST(SR.[+2EVENTS37-72MIS] AS DECIMAL(15, 2)) / CAST(SR.NumberOfSales AS DECIMAL(15, 2))) * 100, 0) AS INT) AS VARCHAR(5)) + '%'
		FROM #ServiceRetention SR
