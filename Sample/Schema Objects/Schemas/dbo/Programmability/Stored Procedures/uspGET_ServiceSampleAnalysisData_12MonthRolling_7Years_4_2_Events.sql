CREATE PROCEDURE [dbo].[uspGET_ServiceSampleAnalysisData_12MonthRolling_7Years_4_2_Events]
@RunDate DATE
AS
SET XACT_ABORT ON
		SET NOCOUNT ON
	...
	/* 
		...
		2.1			22/01/2020			Chris Ledger		Bug 15372 - Fix database references and cases
	...
	/* ADD COUNT OF VEHICLES WITH +2 SERVICE EVENTS BETWEEN 37MIS AND 72MIS */	
			...
			INNER JOIN
				(
					...
					WHERE [ServiceEventCount37-72MIS] >= 4
					GROUP BY 
						Manufacturer
						, Market
						, YearOfSales
