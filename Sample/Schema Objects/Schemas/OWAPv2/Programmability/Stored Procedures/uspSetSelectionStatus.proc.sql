CREATE PROC OWAPv2.uspSetSelectionStatus
(
...
/*
	...
	1.2				16-Sep-2016		Chris Ross			Move to schema OWAPv2
	...
	BEGIN TRAN
		...
		BEGIN
			...
			SET DateOutputAuthorised = null,
				AuthorisingPartyID = @UserPartyID,
				AuthorisingRoleTypeID = @UserRoleTypeID,
				SelectionStatusTypeID = (SELECT SST.SelectionStatusTypeID FROM Requirement.SelectionStatusTypes SST WHERE SST.SelectionStatusType = 'Selected')
			WHERE RequirementID = @SelectionID
