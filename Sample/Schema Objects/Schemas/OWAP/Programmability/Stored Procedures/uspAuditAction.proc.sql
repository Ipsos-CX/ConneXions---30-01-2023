CREATE PROC OWAP.uspAuditAction
(
	@AuditID INT, 
	@ActionDate DATETIME2,
	@UserPartyID INT = NULL, 
	@UserRoleTypeID SMALLINT = NULL, 
	@AuditItemID INT = 0 OUTPUT, 
...
/*
	Purpose:	Creates and AuditItemID for an OWAP action and links it to the AuditID for the OWAP session
