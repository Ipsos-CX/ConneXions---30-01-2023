--task 691
CREATE TABLE [SampleReport].[DispoCQI](
	[Market_] [varchar](200) NULL,
	[Questionnaire_] [varchar](255) NULL,
	[Brand_] [nvarchar](510) NULL,
	[FileName] [varchar](100) NOT NULL,
	[FileRowCount] [int] NULL,
	[EndDays_] [int] NULL,
	[StartDays_] [int] NULL,
	[Sale_Date] [datetime2](7) NULL,
	[EndWindow] [datetime] NULL,
	[StartWindow] [datetime] NULL,
	[CaseID_] [varchar](11) NULL,
	...
	[CQIMissingExtraVehicleFeed] [bit] NULL,
	[GeneralEnquiryDate] [datetime2](7) NULL,
	[MissingPerson] [bit] NULL,
	[MissingOrganisation] [bit] NULL,
	[InvalidDealerBrand] [bit] NULL,
	[PreviousCaseDate] [varchar](30) NULL,
	[CASES] [int] NOT NULL,
	[TOTAL] [int] NOT NULL
) ON [PRIMARY]
GO