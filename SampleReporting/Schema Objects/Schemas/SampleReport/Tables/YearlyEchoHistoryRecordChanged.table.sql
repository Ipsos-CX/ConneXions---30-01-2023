CREATE TABLE [SampleReport].[YearlyEchoHistoryRecordChanged]
(
	...
	[DuplicateFileFlag] [int] NOT NULL,
	...
	[CheckSumCalc] [bigint] NULL,
	[ConcatenatedData] nvarchar(max) NULL,
	[PDIFlagSet] [int] NULL,
	[ContactPreferencesModel] varchar(50) NULL,                  -- BUG 14379
	[ContactPreferencesPersist] INT NULL,					     -- BUG 14379		
	...
	[DealerPartyID] INT NULL,									 -- BUG 14906
	...
	[MatchedODSPrivEmailAddressID] INT NULL,   -- BUG 15216
	...
	[NoMatch_CRCAgent]  INT NULL, -- TASK 1053, 
	[NoMatch_InviteBMQ] INT NULL, -- TASK 1053, 
	[NoMatch_InviteLanguage] INT NULL, -- TASK 1053,
	[DedupeHistoric] INT NULL, -- TASK 1053,
	[MedalliaSent] INT NULL -- TASK 1053
