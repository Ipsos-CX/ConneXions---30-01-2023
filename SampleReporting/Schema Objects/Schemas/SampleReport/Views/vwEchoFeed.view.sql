CREATE VIEW [SampleReport].[vwEchoFeed]
AS 
...
/*
	...
	1.1			20140729	Eddie Thomas			Added additional fields
	1.2			20150202	Eddie Thomas			Added additional fields
	1.3			20151603	Eddie Thomas			Datediff function was generating an overflow error with sample date stamped as 1900-01-01
	1.4			2016-03-30  Chris Ledger			R
	1.5			20160621	Eddie Thomas			PreOwned surveytype was being output as 0
	1.6			29092016	Ben King				BUG 13089 - add AgentCodeFlag
	1.7			01112016	Ben King				BUG 13267 - add SurveyTypeId in for Roadside & CRC
	1.8			30112016	Ben King				BUG 13358 - add new fields
	1.8			30112016	Ben King				BUG 13358 - add new fields
	1.9			01022017	Ben King				BUG 13546 - Echo sample reports NA changes - add employee reporting fields
	1.10		23032017	Ben King			    BUG 13465 - Add FOBCode to Echo & SampleReports (individual Sheet) 
	1.11		26/04/2017	Chris Ross				BUG 13364 - Add in Customer Preference columns
	1.12		17/05/2017	Ben King				BUG 13933 & 13884 - Add fields SVCRMSalesType, SVCRMInvalidSalesType, DealNumber, RepairOrderNumber, VistaCommonOrderNumber	
	1.13		24/05/2017	Ben King			    BUG 13950 - Echo reporting change - employee reporting for generic roles
	1.14		31/05/2017	Ben King			    BUG 13985 - Echo Report Changes: Add AuditItemId and correct Sales codes & Names variables.
	1.15		20/06/2017  Ben King				BUG 14033 - Add Field RecordChanged to Echo output
	1.16		07/09/2017	Chris Ross				BUG 14122 - Add in PDIFlagSet column
	1.17		08/09/2017	Eddie Thomas			BUG 14141 - New Bodyshop questionnaire
	1.18		14/11/2017  Ben King				BUG 14379 - 14379 - New Suppression Logic_for Sample Reporting Purposes
	1.19		21/12/2017	Ben King			    BUG 14455 - Anonymity on Sample reporting website
	1.20		19/01/2018	Ben King				BUG 14493 - Add anonymous flags to echo output
	1.21		19/01/2018	Ben King				BUG 14487 - OtherExclusion field
	1.22		14/03/2018	Ben King			    BUG 14486 - Customer Preference Override Flag		
	1.23		01/05/2018	Ben King			    BUG 14669 - GDPR New Flag_ Sample Reporting
	1.24		03/01/2020	Ben King			    BUG 16864 - Add exclusion category flags
	1.25		02/02/2021	Ben King				BUG 18093 - add 10digit code (plus other fields)
	1.26		25/02/2021	Ben King				BUG 18126 - ADD EventID to Website sample reporting.
	1.27		10/03/2021	Ben King				BUG 18128 - Sample Reporting: Filter on "Core" markets when base table builds
	1.28		23/03/2021  Ben King                BUG 18153 - Sample Reporting - Report & remove selected without 10 Dig Dealer code
	1.29		26/03/2021	Ben King			    BUG 18158 - Add the crc agent cdsid field to sample reports feed
	1.30        23/04/2021  Ben King                BUG 18188 - Medallia Sample reporting files - update needed to PII (N/A) fields to not be blanked out
	1.31		10/06/2021	Ben King				TASK 474 - Japan Purchase - Mismatch between Dealer and VIN
	1.32		17/06/2021	Ben King				TASK 495 - Sample reporting for General Enquiries
	1.33        02/11/2021  Ben King                TASK 646 - Lost Leads Sample reporting feed for Medallia
	1.34		30/09/2022	Eddie Thomas			TASK 1017 - Add SubBrand
	1.35		05/10/2022	Eddie Thomas			TASK 926 - Adding ModelCode & ModelDescription 
	1.36		13/10/2022	Eddie Thomas			TASK 1064 - Adding LeadVehSaleType & ModelVariant
*/
	...
	FROM SampleReport.IndividualRows IR
