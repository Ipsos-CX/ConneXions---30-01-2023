CREATE PROCEDURE [CaseUpdate].[uspSuppressionFile_AuditFileRows]
...
/*
	...
	1.0				16/07/2013		Martin Riverol		Created
*/
...
BEGIN TRY
	...
	BEGIN TRAN
		...
		UPDATE CaseUpdate.SuppressionFile
		...
		SELECT
			AuditID,
			AuditItemID
		FROM CaseUpdate.SuppressionFile
