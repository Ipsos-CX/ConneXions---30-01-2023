CREATE PROCEDURE [CaseUpdate].[uspCRMResponseFile_AuditFileRows]

AS

/*
	Purpose:	Generate AuditItems and write them to Audit and the Response Load table
...
BEGIN TRY
	...
	BEGIN TRAN
		...
		UPDATE CaseUpdate.CRMResponseFile
		...
		SELECT
			AuditID,
			AuditItemID
		FROM CaseUpdate.CRMResponseFile
