CREATE VIEW [China].[vwLoadServiceToVWT]
...
SELECT DISTINCT
		...
		SWR.ServiceEventDate AS ServiceDateOrig,
		SWR.ConvertedServiceEventDate AS ServiceDate,
		...
		SWR.DealerCode AS ServiceDealerCode,
		SWR.DealerCodeOriginatorPartyID AS ServiceDealerCodeOriginatorPartyID

FROM [China].[Service_WithResponses] SWR
