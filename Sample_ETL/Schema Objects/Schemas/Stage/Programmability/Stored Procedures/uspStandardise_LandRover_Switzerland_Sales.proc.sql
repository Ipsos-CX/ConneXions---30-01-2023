...
CREATE PROCEDURE Stage.uspStandardise_LandRover_Switzerland_Sales
AS
...
/*
	...
	1.0				$(ReleaseDate)		Simon Peacock		Created from [Prophet-ETL].dbo.uspSTANDARDISE_STAGE_LandRover_Switzerland_Sales
...
BEGIN TRY
	...
	UPDATE	Stage.LandRover_Switzerland_Sales
    ...
    FROM    Stage.LandRover_Switzerland_Sales
...
BEGIN CATCH
	...
	EXEC('
		SELECT *
		INTO [$(ErrorDB)].Stage.LandRover_Switzerland_Sales_' + @TimestampString + '
		FROM Stage.LandRover_Switzerland_Sales
	')
