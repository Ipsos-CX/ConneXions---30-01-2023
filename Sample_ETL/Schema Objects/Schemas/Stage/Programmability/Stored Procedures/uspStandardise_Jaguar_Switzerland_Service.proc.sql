...
CREATE PROCEDURE Stage.uspStandardise_Jaguar_Switzerland_Service
AS
...
/*
	...
	1.0				$(ReleaseDate)		Simon Peacock		Created from [Prophet-ETL].dbo.uspSTANDARDISE_STAGE_Jaguar_Switzerland_Service
...
BEGIN TRY
	...
	UPDATE	Stage.Jaguar_Switzerland_Service
    ...
    FROM    Stage.Jaguar_Switzerland_Service
...
BEGIN CATCH
	...
	EXEC('
		SELECT *
		INTO [$(ErrorDB)].Stage.Jaguar_Switzerland_Service_' + @TimestampString + '
		FROM Stage.Jaguar_Switzerland_Service
	')
