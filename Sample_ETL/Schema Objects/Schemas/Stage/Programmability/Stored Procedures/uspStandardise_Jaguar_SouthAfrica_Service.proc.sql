CREATE PROCEDURE Stage.uspStandardise_Jaguar_SouthAfrica_Service 
AS
...
/*
	...
	1.0				$(ReleaseDate)				Created from Stage.Jaguar_SouthAfrica_Service
...
BEGIN TRY
	...
	UPDATE	Stage.Jaguar_SouthAfrica_Service
...
BEGIN CATCH
	...
	EXEC('
		SELECT *
		INTO [$(ErrorDB)].Stage.Jaguar_SouthAfrica_Service_' + @TimestampString + '
		FROM Stage.Jaguar_SouthAfrica_Service
	')
