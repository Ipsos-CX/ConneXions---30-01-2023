CREATE PROCEDURE Stage.uspStandardise_Jaguar_Ireland_Service
AS
...
BEGIN TRY
	...
	UPDATE Stage.Jaguar_Ireland_Service
...
BEGIN CATCH
	...
	EXEC('
		SELECT *
		INTO [$(ErrorDB)].Stage.Jaguar_Ireland_Service_' + @TimestampString + '
		FROM Stage.Jaguar_Ireland_Service
	')
