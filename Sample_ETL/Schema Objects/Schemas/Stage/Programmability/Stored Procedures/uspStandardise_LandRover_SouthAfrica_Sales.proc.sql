CREATE PROCEDURE Stage.uspStandardise_LandRover_SouthAfrica_Sales 
AS
...
/*
	...
	1.0				$(ReleaseDate)				Created from Stage.LandRover_SouthAfrica_Sales
...
BEGIN TRY
	...
	UPDATE	Stage.LandRover_SouthAfrica_Sales
...
BEGIN CATCH
	...
	EXEC('
		SELECT *
		INTO [$(ErrorDB)].Stage.LandRover_SouthAfrica_Sales_' + @TimestampString + '
		FROM Stage.LandRover_SouthAfrica_Sales
	')
