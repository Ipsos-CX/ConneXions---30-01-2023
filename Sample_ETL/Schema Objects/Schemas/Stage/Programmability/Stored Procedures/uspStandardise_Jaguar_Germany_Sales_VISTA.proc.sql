CREATE PROCEDURE [Stage].[uspStandardise_Jaguar_Germany_Sales_VISTA]
AS
...
/*
	...
	1.0				$(ReleaseDate)		Simon Peacock		Created from [Prophet-ETL].dbo.uspStandardise_Jaguar_Germany_Sales_VISTA
...
BEGIN TRY
	...
	UPDATE	Stage.Jaguar_Germany_Sales_VISTA
	...
	--FROM	Stage.Jaguar_Germany_Sales_VISTA
...
BEGIN CATCH
	...
	EXEC('
		SELECT *
		INTO [$(ErrorDB)].Stage.Jaguar_Germany_Sales_VISTA_' + @TimestampString + '
		FROM Stage.Jaguar_Germany_Sales_VISTA
	')
