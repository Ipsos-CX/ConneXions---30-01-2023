CREATE PROCEDURE Stage.uspStandardise_Jaguar_Brazil_Service 
AS
...
BEGIN TRY
	...
	UPDATE	Stage.Jaguar_Brazil_Service
...
BEGIN CATCH
	...
	EXEC('
		SELECT *
		INTO [$(ErrorDB)].Stage.Jaguar_Brazil_Service_' + @TimestampString + '
		FROM Stage.Jaguar_Brazil_Service
	')
