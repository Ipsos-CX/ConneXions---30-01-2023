CREATE PROCEDURE Stage.uspStandardise_LandRover_Brazil_Service 
AS
...
/*
	...
	1.0				$(ReleaseDate)				Created from [Prophet-ETL].dbo.uspSTANDARDISE_STAGE_Landrover_Brazil_Service
...
BEGIN TRY
	...
	UPDATE	Stage.LandRover_Brazil_Service
...
BEGIN CATCH
	...
	EXEC('
		SELECT *
		INTO [$(ErrorDB)].Stage.LandRover_Brazil_Service_' + @TimestampString + '
		FROM Stage.LandRover_Brazil_Service
	')
