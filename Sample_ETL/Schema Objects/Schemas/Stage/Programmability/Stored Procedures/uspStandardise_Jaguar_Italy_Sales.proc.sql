CREATE PROCEDURE Stage.uspStandardise_Jaguar_Italy_Sales
AS
...
/*
	...
	1.0				$(ReleaseDate)		Simon Peacock		Created from [Prophet-ETL].dbo.uspSTANDARDISE_STAGE_Jaguar_Italy_Sales
...
BEGIN TRY
	...
	UPDATE Stage.Jaguar_Italy_Sales
...
BEGIN CATCH
	...
	EXEC('
		SELECT *
		INTO [$(ErrorDB)].Stage.Jaguar_Italy_Sales_' + @TimestampString + '
		FROM Stage.Jaguar_Italy_Sales
	')
