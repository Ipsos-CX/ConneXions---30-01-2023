CREATE PROCEDURE Stage.uspStandardise_Jaguar_Austria_Service
AS
...
/*
	...
	1.0				03/03/2014		Ali Yuksel			Created from uspStandardise_Jaguar_Australia_Service.proc.sql
...
BEGIN TRY
	...
	UPDATE	Stage.Jaguar_Austria_Service
...
BEGIN CATCH
	...
	EXEC('
		SELECT *
		INTO [$(ErrorDB)].Stage.Jaguar_Austria_Service_' + @TimestampString + '
		FROM Stage.Jaguar_Austria_Service
	')
