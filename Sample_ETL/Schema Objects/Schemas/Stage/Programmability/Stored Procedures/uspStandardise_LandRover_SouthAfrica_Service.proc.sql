CREATE PROCEDURE Stage.uspStandardise_LandRover_SouthAfrica_Service 
AS
...
/*
	...
	1.0				$(ReleaseDate)				Created from Stage.LandRover_SouthAfrica_Service
...
BEGIN TRY
	...
	UPDATE	Stage.LandRover_SouthAfrica_Service
...
BEGIN CATCH
	...
	EXEC('
		SELECT *
		INTO [$(ErrorDB)].Stage.LandRover_SouthAfrica_Service_' + @TimestampString + '
		FROM Stage.LandRover_SouthAfrica_Service
	')
