CREATE PROCEDURE Stage.uspStandardise_Jaguar_Italy_Service
AS
...
BEGIN TRY
	...
	UPDATE Stage.Jaguar_Italy_Service
	...
	--BUG 13444
	UPDATE	Stage.Jaguar_Italy_Service
	SET		OwnershipCycle = CAST(OwnershipCycle AS TINYINT)
	WHERE	OwnershipCycle IS NOT NULL
...
BEGIN CATCH
	...
	EXEC('
		SELECT *
		INTO [$(ErrorDB)].Stage.Jaguar_Italy_Service_' + @TimestampString + '
		FROM Stage.Jaguar_Italy_Service
	')
