CREATE PROCEDURE Stage.uspStandardise_LandRover_Australia_Service 
AS
...
/*
	...
	1.0				$(ReleaseDate)		Simon Peacock		Created from [Prophet-ETL].dbo.uspSTANDARDISE_STAGE_landrover_Australia_AfterSales_Dates
...
BEGIN TRY
	...
	UPDATE	Stage.LandRover_Australia_Service
...
BEGIN CATCH
	...
	EXEC('
		SELECT *
		INTO [$(ErrorDB)].Stage.LandRover_Australia_Service_' + @TimestampString + '
		FROM Stage.LandRover_Australia_Service
	')
