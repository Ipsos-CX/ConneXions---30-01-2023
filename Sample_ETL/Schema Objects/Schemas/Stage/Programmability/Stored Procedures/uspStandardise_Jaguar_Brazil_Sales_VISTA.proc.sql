CREATE PROCEDURE [Stage].[uspStandardise_Jaguar_Brazil_Sales_VISTA]
AS
...
/*
	...
	1.0				22/01/2014		Chris Ross			Original Version
...
BEGIN TRY
	...
	UPDATE	Stage.Jaguar_Brazil_Sales_VISTA
...
BEGIN CATCH
	...
	EXEC('
		SELECT *
		INTO [$(ErrorDB)].Stage.Jaguar_Brazil_Sales_VISTA_' + @TimestampString + '
		FROM Stage.Jaguar_Brazil_Sales_VISTA
	')
