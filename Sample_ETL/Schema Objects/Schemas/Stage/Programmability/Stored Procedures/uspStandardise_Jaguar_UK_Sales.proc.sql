CREATE PROCEDURE Stage.uspStandardise_Jaguar_UK_Sales 
AS
...
/*
	...
	1.0				$(ReleaseDate)		Simon Peacock		Created from [Prophet-ETL].dbo.uspSTANDARDISE_STAGE_Jaguar_UK_Sales_Dates
...
BEGIN CATCH
	...
	EXEC('
		SELECT *
		INTO [$(ErrorDB)].Stage.Jaguar_UK_Sales_' + @TimestampString + '
		FROM Stage.Jaguar_UK_Sales
	')
