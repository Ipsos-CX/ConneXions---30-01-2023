CREATE PROCEDURE Stage.uspStandardise_Jaguar_UK_Service_LoyaltyLogistix
AS
...
BEGIN TRY
	...
	UPDATE	Stage.Jaguar_UK_Service_LoyaltyLogistix
	...
	IF EXISTS( 
			...
			SELECT ModelYear 
			FROM   Stage.Jaguar_UK_Service_LoyaltyLogistix
	...
	BEGIN 
			...
			FROM	Stage.Jaguar_UK_Service_LoyaltyLogistix LL
