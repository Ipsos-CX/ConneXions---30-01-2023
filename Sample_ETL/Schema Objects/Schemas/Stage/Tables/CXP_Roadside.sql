CREATE TABLE [Stage].[CXP_Roadside]
(
	...
	VehicleReplacementTime dbo.LoadText NULL,

	CarHireStartTime			loadtext NULL,
	ConvertedCarHireStartTime	time NULL,
	RepairingDealerCountry		loadtext NULL,
	RoadsideAssistanceProvider	loadtext NULL,
	BreakdownAttendingResource	loadtext NULL,
	CarHireProvider				loadtext NULL,
	CountryCodeISOAlpha2		loadtext NULL,
	BreakdownCountryISOAlpha2	loadtext NULL,
