CREATE TABLE [Stage].[LandRover_France_Sales_VISTA_CQI]
(
	[ID] [int] IDENTITY(1,1) NOT NULL, --BUG 18201
	...
	[SMS] [dbo].[LoadText] NULL,
	[Telephone] [dbo].[LoadText] NULL,
	[Email] [dbo].[LoadText] NULL,
	[Digital] [dbo].[LoadText] NULL,
	[PublicationDate] [dbo].[LoadText] NULL,
	[SMSDate] [dbo].[LoadText] NULL,
	[TelephoneDate] [dbo].[LoadText] NULL,
	[EmailDate] [dbo].[LoadText] NULL,
	[Date num?rique] [dbo].[LoadText] NULL
)
