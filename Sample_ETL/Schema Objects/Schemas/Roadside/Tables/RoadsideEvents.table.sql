...
CREATE TABLE [Roadside].[RoadsideEvents](
	[RoadsideID] [int] IDENTITY(1,1) NOT NULL,
	...
	CountryCodeISOAlpha2		loadtext NULL,	-- 8976 - New fields  -- This is the Address8 (2 digit) Country Code from the SampleFile
	BreakdownCountryISOAlpha2	loadtext NULL,	-- 8976 - New fields
	
	PreferredLanguageID				int	NULL,		-- 8976 - New fields
	PerformNormalVWTLoadFlag		varchar(1) NULL,-- 8976 - To indicate whether we do normal/full VWT load or original Roadside load processing
