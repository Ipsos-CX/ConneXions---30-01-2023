CREATE PROCEDURE CustomerUpdate.uspRegistrationNumber_AuditFileRows
...
/*
	...
	1.0				$(ReleaseDate)		Simon Peacock		Created from [Prophet-ETL].dbo.uspODSLOAD_AddCustomerUpdateREGISTRATIONNUMBERAuditFileRows
...
BEGIN TRY
	...
	BEGIN TRAN
		...
		UPDATE CustomerUpdate.RegistrationNumber
