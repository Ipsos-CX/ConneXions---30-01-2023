CREATE PROCEDURE CustomerUpdate.uspTelephoneNumber_AuditFileRows
...
/*
	...
	1.0				$(ReleaseDate)		Simon Peacock		Created from [Prophet-ETL].dbo.uspODSLOAD_AddCustomerUpdateTELEPHONENUMBERAuditFileRows
...
BEGIN TRY
	...
	BEGIN TRAN
		...
		UPDATE CustomerUpdate.TelephoneNumber
