CREATE PROCEDURE CustomerUpdate.uspDealer_AuditFileRows
...
/*
	...
	1.0				$(ReleaseDate)		Simon Peacock		Created from [Prophet-ETL].dbo.uspODSLOAD_AddCustomerUpdateDEALERAuditFileRows
