CREATE PROCEDURE CustomerUpdate.uspRegistrationNumber_Dedupe
...
/*
	...
	1.0				$(ReleaseDate)		Simon Peacock		Created from [Prophet-ETL].dbo.uspIP_CUSTOMERUPDATE_Dedupe_RegistrationNumber
...
BEGIN TRY
	...
	FROM CustomerUpdate.RegistrationNumber R
	INNER JOIN (
		SELECT
	...
	) M ON M.CaseID = R.CaseID AND M.PartyID = R.PartyID
