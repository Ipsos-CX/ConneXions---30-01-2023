CREATE VIEW [GeneralEnquiry].[vwCombinedLoadToVWT]
AS
SELECT DISTINCT 
	WE.GeneralEnquiryID, 
	WE.AuditID, 
	...
	(SELECT EventTypeID FROM [$(SampleDB)].Event.EventTypes WHERE EventType = 'CRC General Enquiry') AS EventTypeID,
	B.ManufacturerPartyID as CRCCentreOriginatorPartyID, 
	WE.CRCCentreCode,
	We.GeneralEnquiryDateOrig, 
	We.GeneralEnquiryDate,
...
--SELECT B.*, * 	
FROM GeneralEnquiry.GeneralEnquiryEvents WE
