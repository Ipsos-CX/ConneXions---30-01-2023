CREATE VIEW [CRM].[vwPreOwned_TransferToVWT]
AS 

/*
	Purpose:	Identify which CRM sourced PreOwned events have yet to be transferred to VWT
	
	Version		Developer			Date			Comment
	1.11		Chris Ledger		2016-12-02		Created
	1.12		Chris Ledger		11/01/2017		BUG 13280: Add US Specific Addressing Rules
	1.13		Chris Ledger		05/05/2017		BUG 13790: Exclude records where ACCT_COUNTRY_CODE IS NULL
...
--		ACCT_PREFIX_2,
	...
	WHERE DateTransferredToVWT IS NULL																-- V1.6
