CREATE VIEW [CRM].[vwLandRover_Experience_TransferToVWT]
AS 

/*
	Purpose:	Identify which CRM sourced Land Rover Experience events have yet to be transferred to VWT
	...
	1.24		Ben King			2022-05-26		TASK 879: LR Expereince
*/
	...
	(
		...
		FROM CRM.LandRover_Experience CRM
...
--		ACCT_PREFIX_2,
		...
		RESPONSE_ID,								-- V1.20
		CONVERT(DATE,DATEADD(dd,-2,GETDATE())) AS LandRoverExperienceDateOrig,
		CONVERT(DATE,DATEADD(dd,-2,GETDATE())) AS LandRoverExperienceDate,
		'H00XX' AS ExperienceDealerCode,
		3 AS ExperienceDealerCodeOriginatorPartyID
