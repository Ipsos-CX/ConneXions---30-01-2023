CREATE TABLE [CRM].[General_Enquiry](
	...
	[Converted_GENERAL_ENQRY_INTERACTION_DATE] [datetime2] (7) NULL,	-- Added with SC00146 Version 9.1 (see TASK 299)
	[DateTransferredToVWT] [datetime2](7) NULL,
	[SampleTriggeredSelectionReqID] int		 NULL,
	Calculated_Salutation  nvarchar(200) NULL,					-- BUG 16731
	Calculated_Title  nvarchar(30) NULL,						-- BUG 16731
	...
	VEH_FUEL_TYPE_CODE       nvarchar(10)     NULL,				-- 15234 - Size increased to 10
	...
	DMS_TOTAL_CUSTOMER_PRICE         decimal(17)      NULL,		-- BUG 15234 - Bringing all staging tables in line
	VISTACONTRACT_COMMON_ORDER_NUM	nvarchar(35)	  NULL,		-- BUG 15234 - Bringing all staging tables in line
	...
	GENERAL_ENQUIRY_BRAND						NVARCHAR(20) NULL,  -- Added with SC00146 Version 9.1 (see TASK 299) 
	GENERAL_ENQUIRY_COMM_TYPE					NVARCHAR(20) NULL,  -- Added with SC00146 Version 9.1 (see TASK 299) 
	GENERAL_ENQRY_INTERACTION_DATE				NVARCHAR(10) NULL,  -- Added with SC00146 Version 9.1 (see TASK 299) 
	GENERAL_ENQUIRY_EMP_RES_NAME				NVARCHAR(81) NULL,  -- Added with SC00146 Version 9.1 (see TASK 299) 
	GENERAL_ENQUIRYY_VEH_REG_NO					NVARCHAR(15) NULL,  -- Added with SC00146 Version 9.1 (see TASK 299) 
	GENERAL_ENQUIRY_VIN_NO						NVARCHAR(35) NULL	-- Added with SC00146 Version 9.1 (see TASK 299) 
