CREATE TABLE [CRM].[DMS_Repair_Service](
	...
	[FilteredOut] bit NOT NULL DEFAULT(0),
...
--	ACCT_PREFIX_2       nvarchar(40)     NULL,
	...
	DMS_SERVICE_ADVISOR       nvarchar(30)     NULL,		-- BUG 13313 - 01/02/2017
	...
	DMS_REPAIR_ORDER_NUMBER_UNIQUE   nvarchar(35)     NULL,		-- BUG 13670 - 2017-03-15
	
	DMS_OTHER_RELATED_SERVICES		nvarchar(max)  NULL	,		-- BUG 14122 - 2017-08-31
	PDI_Flag VARCHAR(1) NULL	,								-- BUG 14122 - 2017-08-31
