...
CREATE VIEW Audit.vwSampleFiles
AS

/*
			Purpose:	Returns a list of all sample files we've loaded into audit
	
			Release		Version			Date			Developer			Comment
			LIVE		1.0				$(ReleaseDate)	Simon Peacock		Created from [Prophet-ETL].dbo.vwAUDIT_SampleFiles
